...
# Load the model
model = joblib.load('/Twitter_Sentiment_Analysis/user_interface/twitter_sentiment_analysis_model.pkl')
 
# Load the vectorizer
vectorizer = joblib.load('/Twitter_Sentiment_Analysis/user_interface/vectorizer.pkl')
